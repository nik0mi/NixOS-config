  ...
  programs.yazi = {
    ...
    keymap = {
      mgr.prepend_keymap = [
        ...
        { on = [ "g" "a" ]; run = "plugin gvfs -- jump-to-device"; desc = "Select device then jump to its mount point"; }
        { on = [ "g" "a" ]; run = "plugin gvfs -- jump-to-device --automount"; desc = "Automount then select device to jump to its mount point"; }
